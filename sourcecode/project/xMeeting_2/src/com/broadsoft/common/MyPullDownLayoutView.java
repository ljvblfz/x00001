 ...
 */
public class MyPullDownLayoutView extends LinearLayout implements OnScrollOverListener{
	...
	private static final int DEFAULT_HEADER_VIEW_HEIGHT = 90;	// 头部文件原本的高度
	...
	private MyScrollOverListView mListView;
	...
	public MyPullDownLayoutView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initHeaderViewAndFooterViewAndListView(context);
	}

	public MyPullDownLayoutView(Context context) {
		super(context);
		initHeaderViewAndFooterViewAndListView(context);
	}
	...
	private void initHeaderViewAndFooterViewAndListView(Context context){
		 ...
		 * 同时因为，需要它的监听事件
		 */
		mListView = new MyScrollOverListView(context);
