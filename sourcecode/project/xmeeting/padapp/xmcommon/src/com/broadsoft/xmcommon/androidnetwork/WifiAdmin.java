...
public class WifiAdmin {
	...
	public ArrayList<String> getScanResult() {
		...
		if (mWifiList != null) {
			for (int i = 0; i < mWifiList.size(); i++) {
				...
				wifiNames.add(mStringBuffer.toString());
			}
		}
	...
	public void autoConnect() {
		...
		if (mWifiList != null) {
			for (int i = 0; i < mWifiList.size(); i++) {
				mScanResult = mWifiList.get(i);
				if (mScanResult.SSID.toString().contains("sh_002")) {
	...
	// 添加一个网络并连接
	/*
	 * public void addNetwork(WifiConfiguration wcg) { int wcgID =
	 * mWifiManager.addNetwork(wcg); boolean b =
	 * mWifiManager.enableNetwork(wcgID, true); System.out.println("a--" +
	 * wcgID); System.out.println("b--" + b); }
	 */
