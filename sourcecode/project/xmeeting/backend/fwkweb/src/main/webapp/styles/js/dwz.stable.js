...
(function($){
	$.fn.jTable = function(options){
		return this.each(function(){
			...
			tbody.wrap("<div class='gridScroller'" + customHeightStr+" "+layoutStr + " style='width:" + $tc.width() + "px; "+heightStr+"'><div class='gridTbody'><table style='width:" + (tlength - 20) + "px;'></table></div></div>");
