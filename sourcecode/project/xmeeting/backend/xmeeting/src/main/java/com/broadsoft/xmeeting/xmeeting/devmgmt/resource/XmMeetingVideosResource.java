...
import com.broadsoft.xmeeting.xmeeting.devmgmt.vo.XmMeetingVideoSearchVO;
import com.founder.sipbus.syweb.au.base.SyBaseResource;

@Component
@Scope(value="prototype")
@RestletResource(urls="/xmMeetingVideo")
public class XmMeetingVideosResource extends SyBaseResource {
	...
	public Representation get(Representation entity) throws Exception {
		...
		XmMeetingVideoSearchVO sVO=new XmMeetingVideoSearchVO();
		PMGridCopyUtil.copyGridToDto(sVO,getQueryMap());
		PageResponse p = xmMeetingVideoDao.findPage(getPageRequest(),fillDetachedCriteria(XmMeetingVideo.class,sVO));
	...
	public Representation post(Representation entity)
		...
		form = new Form(entity);
		XmMeetingVideo xmMeetingVideo = new XmMeetingVideo();
		PMGridCopyUtil.copyGridToDto(xmMeetingVideo, form.getValuesMap());
		xmMeetingVideoDao.add(xmMeetingVideo);
