...
import com.founder.odyssey.generator.utils.DatabaseDataTypesUtils;
...
//	private final String comments;
	...
	public boolean isCcuu() {
		return "create_by".equalsIgnoreCase(this._sqlName)
		||"create_dt".equalsIgnoreCase(this._sqlName)
		||"update_by".equalsIgnoreCase(this._sqlName)
		||"update_dt".equalsIgnoreCase(this._sqlName)
		||"del_flag".equalsIgnoreCase(this._sqlName);
	}
	/**
	...
	public boolean getIsCreateOrUpdate(){
		return _sqlName.equals("CREATE_BY")||_sqlName.equals("CREATE_DT")||_sqlName.equals("UPDATE_DT")
				||_sqlName.equals("UPDATE_BY");
	}
}
