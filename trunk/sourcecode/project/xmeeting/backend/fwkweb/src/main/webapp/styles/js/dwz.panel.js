	...
	$.extend($.fn, {
		jPanel:function(options){
			...
			return this.each(function(){
				...
				var $content = $(">div:first", $panel).addClass(op.content);		
				...
				if (close) 
					...
					if($content.attr("customHeight")) 
						$content.height($content.attr("customHeight") + "px"); 
					else{
						if (defaultH > 0) 
				...
				$pucker.bind("click",function(event){
