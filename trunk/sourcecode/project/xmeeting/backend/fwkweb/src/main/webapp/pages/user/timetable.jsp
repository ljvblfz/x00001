...
function createAduitShiftTimeTr(data){
	var detail = data.detail;
	var html = "<tr>";
...
<div class="pageContent" style="position: relative;overflow: auto; display: inline;">					
	<div id="timetableworkflow"  style="display: inline;">
