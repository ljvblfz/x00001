...
public class ControllerMessageInbound extends MessageInbound {
	...
	protected void onClose(int status) {
		...
		if(MessageInboundHolder.checkIfExist(this)){
			MessageInboundHolder.getSocketListByMeetingId(meetingId).remove(this);
	...
	protected void onOpen(WsOutbound outbound) {
		...
		if(!MessageInboundHolder.checkIfExist(this)){
			...
			MessageInboundHolder.getSocketListByMeetingId(meetingId).add(this); 
		}else{ 
			if(logger.isTraceEnabled()){
