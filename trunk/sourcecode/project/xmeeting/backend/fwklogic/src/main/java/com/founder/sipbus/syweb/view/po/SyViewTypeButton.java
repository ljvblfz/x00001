 ...
 */
@Entity
@Table(name = "SY_VIEW_TYPE_BUTTON")

public class SyViewTypeButton extends BaseEntity {
	...
	public SyViewTypeButton(){
	}

	public SyViewTypeButton(java.lang.String sctbGuid ){
	...
	public int compareTo(Object obj) {
		...
		if (obj == null)
			...
			SyViewTypeButton castObj = (SyViewTypeButton) obj;
