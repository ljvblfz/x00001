	...
	public void initBasicInfo() { 
		...
		btnnavcompanybasicinfo.setOnClickListener(new Button.OnClickListener() {  
			...
			public void onClick(View view) {  
				...
				LinearLayout personalinfo = (LinearLayout) getLayoutInflater().inflate(R.layout.company_basicinfo, null);
				companycontent.removeAllViewsInLayout();
				companycontent.addView(personalinfo); 
//				WebView browser =(WebView)companycontent.findViewById(R.id.wbBasicInfo);
//				
...
//				browser.loadData(htmlBasicInfo,  "text/html" ,"UTF-8");
			}
